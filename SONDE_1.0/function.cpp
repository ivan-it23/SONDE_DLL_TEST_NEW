...
double  Ro_0 = 0.01;  //����������� �������� �� ��� �������
double  Ro_max = 10000;  //������������ �������� �� ��� �������
double epsilon_ABS = 0.0000005; // �������� ,�� ������� �������� ��������� ��������� 
double epsilon_ARG = 0.0000005; // �������� ,�� ������� �������� ��������� ����
double delta;
double  ro_0 = Ro_0;
...
// Мирроринг get_sonde_id из SONDE_DLL_NEW (SondeCore.cpp): младшие 6 разрядов —
...
float RO_dFI(SONDE_PARAM param, double dfi) {
	float Ro0;
	float epsilon_ARG = 0.0000005f; // ��������  ���� � ��������� 
	float  Ro_0 = 0.01f, Ro_max = 7000.0f;  //���. � ���. �������� �� ��� �������
	float delta;
	float  ro_0 = Ro_0;
	float  ro_max = Ro_max;
	//  �������� ��� 
